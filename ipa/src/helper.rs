...
// <z, w> = <r, c>
// a \odot b = c
pub fn generate_r1cs_inner_relation<P: Pairing> (
    m: usize,
    l: usize,
...
pub fn generate_r1cs_polynomial_relation<P: Pairing> (
    ...
    let r1cs_vecs = generate_r1cs_inner_relation::<P>(m, l, &challenge_r);
...
pub fn generate_de_r1cs_polynomial_relation<P: Pairing> (
    ...
    let (polynomials_x, polynomials_w) = generate_de_sumcheck_polynomials_from_vectors::<P>(m, l, &r1cs_vecs.vec_x, &r1cs_vecs.vec_w);
    let (polynomials_y, _) = generate_de_sumcheck_polynomials_from_vectors::<P>(m, l, &r1cs_vecs.vec_y, &r1cs_vecs.vec_w);
    let (polynomials_z, _) = generate_de_sumcheck_polynomials_from_vectors::<P>(m, l, &r1cs_vecs.vec_z, &r1cs_vecs.vec_w);
    let (polynomials_a, polynomials_b) = generate_de_sumcheck_polynomials_from_vectors::<P>(m, l, &r1cs_vecs.vec_a, &r1cs_vecs.vec_b);
    let (polynomials_c, _) = generate_de_sumcheck_polynomials_from_vectors::<P>(m, l, &r1cs_vecs.vec_c, &r1cs_vecs.vec_b);

    assert_eq!(polynomials_x[0].coeffs.to_vec()[0], r1cs_vecs.vec_x[0]);
    assert_eq!(polynomials_x[0].coeffs.to_vec()[1], r1cs_vecs.vec_x[1]);
    assert_eq!(polynomials_x[0].coeffs.to_vec()[m-1], r1cs_vecs.vec_x[m-1]);
    assert_eq!(polynomials_w[0].coeffs.to_vec()[0], r1cs_vecs.vec_w[0]);
    assert_eq!(polynomials_w[0].coeffs.to_vec()[1], r1cs_vecs.vec_w[m-1]);
    assert_eq!(polynomials_w[0].coeffs.to_vec()[m-1], r1cs_vecs.vec_w[1]);
...
pub fn generate_de_sumcheck_polynomials_from_vectors<P: Pairing> (
    m: usize,
    l: usize,
    vector_left: &Vec<P::ScalarField>,
    vector_right: &Vec<P::ScalarField>,
...
mod tests {
    ...
    fn generate_r1cs_inner_relation_test() {
        ...
        let vectors = generate_r1cs_inner_relation::<Bls12_381>(m, l, &challenge_r);
        ...
        let vectors_test = generate_r1cs_inner_relation::<Bls12_381>(m, l, &challenge_r);
