...
use ark_rollup::{de_rollup::build_multi_tx_circuit, rollup, ConstraintF};
...
// #[test]
// fn rollup_r1cs_satisfication_test() {
//     let l = L;
...
//     let cs = ConstraintSystem::<ConstraintF>::new_ref();
//     let _circuit = rollup::build_multi_tx_circuit::<NUM_TX>().generate_constraints(cs.clone()).unwrap();
//     assert!(cs.is_satisfied().unwrap());
