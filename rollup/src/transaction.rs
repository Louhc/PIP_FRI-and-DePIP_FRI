...
mod test {
    ...
    fn test_cs(rollup: UnaryRollup) -> bool {
        ...
        println!("R1CS num_constraints: {:?}", cs.num_constraints());
        println!("R1CS num_instance_variables: {:?}", cs.num_instance_variables());
        println!("R1CS num_witness_variables: {:?}", cs.num_witness_variables());
        if !result {
