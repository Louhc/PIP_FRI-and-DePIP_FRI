...
impl<P: Pairing> PreProver<P> {
    ...
    pub fn commit_g1_h1_upper_a_t_polys(
        ...
        let coms_upper_a =
            BivBatchKZG::<P>::de_commit(sub_prover_id, &m_powers, &polys_upper_a, m_domain);
    ...
    pub fn commit_upper_b_polys(
        ...
        let coms_upper_b =
            BivBatchKZG::<P>::de_commit(sub_prover_id, &m_powers, &polys_m_srs, m_domain);
    ...
    pub fn commit_f1_f2(
        ...
        let coms_f1 = BivBatchKZG::<P>::de_commit(
            sub_prover_id,
            &m_powers,
            &sub_polys_f1.iter().collect::<Vec<_>>(),
            m_domain,
        );
